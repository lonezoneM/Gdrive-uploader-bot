...
class Messages:
    START_MSG = "**Hi there {}.**\n__I'm Google Drive Uploader Bot. I was created by @i_lab_u_so_much 😍. You can use me to upload any file / video to Google Drive from direct link or Telegram Files.__\n__You can know more from /help.__"
    ...
    HELP_MSG = [
        ...
        "**Developed by @viperadnan and modded by @lonezoneM**"
        ]
